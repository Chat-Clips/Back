...
public class ChatGPTController {
    ...
    public ApiResponse<SendMessageResultDTO> chat(
        ...
        - Always respond in Korean. ex) ~였다, ~했다 etc.
        ...
        - Conversations not directly related to CS, such as physics, chemistry, biological science, earth science, natural disasters, and space, are classified as case 1.
        
        4. Summary Order and Format:
        ...
        - step 4: Case classification : Classify as case 1 or case 2 based on the comprehensive summary. Here is the most relevant sentence in the context:
           - If CS is not a core topic in the comprehensive summary, classify it as case 1. Don't mention the "case 1"
           - If CS is a core topic in the comprehensive summary, classify it as case 2. Don't mention the "case 2"
        - step 5: Whether to provide referral links: Separated into case1 and case2 based on step 4
           - In case 1, you must not provide any recommendation links. Just print "추천 링크: 없음" Don't mention the "case 1"
           - In case 2, you must provide links directly related to computer science or development. Recommend two official sites. Don't mention the "case 2"
        ...
        개별 요약:
        지현: 자연어 처리와 양자 컴퓨팅의 향후 가능성을 강조했다.
